...
public class CrawlMap extends CrawlerUniversal {
	...
	/**
	 * Priority queue, sort crawler threads by the earliest time that they can
	 * politely execute the next request
	 */
	...
	/**
	 * retrieve crawler corresponding to the url's domain add to that domain's
	 * FIFO queue insert crawler to priority queue
	 */
